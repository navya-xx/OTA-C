...
int UHD_SAFE_MAIN(int argc, char *argv[])
{
    ...
    else
    {
        ...
        file = currentDir + "/OTA-C/cpp/storage/save_ref_rx_" + device_id + ".dat";
        if (DEBUG)
...

    {
        ...
        if (DEBUG)
            std::cout << "Initial noise level = " << init_noise_level << std::endl;
        ...
        // Extract peak data
        ch_pow = peak_det_obj.avg_of_peak_vals();
