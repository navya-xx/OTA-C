...
do
    cmd="ssh ${node_name} screen -dmS git_pull_n_make bash -c 'cd \$HOME/OTA-C && git stash && git pull && echo \"success\"" # && cd \$HOME/OTA-C/cpp/build/ && cmake ../ && make -j4 && echo \"Success\"'"
    echo $cmd
    ssh "${node_name}" "screen -dmS git_pull_n_make bash -c 'cd \$HOME/OTA-C && git stash && git pull && echo \"success\"" # && cd \$HOME/OTA-C/cpp/build/ && cmake ../ && make -j4 && echo \"Success\"'"
